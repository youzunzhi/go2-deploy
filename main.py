...
if __name__ == "__main__":
    ...
    parser.add_argument("--logdir", type=str, default='weight-and-cfg/ABS/08_23_17-06-28_model_4000', help="The directory which contains the config and model weights files")
